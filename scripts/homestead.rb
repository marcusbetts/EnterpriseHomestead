    ...
    def Homestead.configure(config, settings)
        ...
        ["vmware_fusion", "vmware_workstation"].each do |vmware|
            config.vm.provider vmware do |v|
                v.vmx["displayName"] = settings["name"] ||= "enterprise-homestead"
        ...
        config.vm.provider "parallels" do |v|
            v.name = settings["name"] ||= "enterprise-homestead"
        ...
        config.vm.provision "shell" do |s|
            ...
            s.inline = "sudo systemctl restart nginx; sudo systemctl restart php71-php-fpm"
        end
        ...
        if settings.has_key?("variables")
            ...
            config.vm.provision "shell" do |s|
                s.inline = "sudo systemctl restart php71-php-fpm"
            end
        end
